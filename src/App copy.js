...
const App = () => {
    ...
    try {
      ...
      switch (param) {
        ...
        case 'word':
          ...
          apiUrl = "https://w3.pppl.gov/communications/web/D-Site_Work_Permit.doc";
          break;
        case 'xl':
          ...
          apiUrl = "https://www.tesourodireto.com.br/data/files/EE/E3/A1/59/6266F610BB8E41E6894D49A8/LFT_2019.xls";
          break;
        case 'text':
  ...
  return (
    <div className="App">
      ...
      {(selectedParams === 'word' && selectedUrl) ?
        <iframe
      ...
      {/* #toolbar=0 {`${selectedPdf}#toolbar=0`} */}
